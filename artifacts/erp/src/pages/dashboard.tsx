...
import { Activity, Briefcase, FileText, Package, Truck, Wallet } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Overview of your operations and key metrics.</p>
      </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">{summary.activeProjects} active currently</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{formatINR(summary.pendingInvoices)}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{summary.openTenders}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{summary.vehiclesInMaintenance}</div>
              <p className="text-xs text-muted-foreground">Out of active fleet</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
